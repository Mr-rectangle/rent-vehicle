                                ...
                                <table class="table table-hover my-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>    
                                            ...
                                            var_dump($rent_data['id_rent']) ;
                                            ?>           
                                               <a  href="modules/rent/edit_my_rent.php?id=<?php echo $rent_data['id_rent'] ?>"><i class="m-r-10 mdi mdi-grease-pencil"></i> </a>
                                            
                                              <a  href="modules/rent/delete_my_rent.php?id=<?php echo $rent_data['id_rent'] ?>">
