                  ...
                  <!-- Column -->
                     <div class="col-lg-8 col-xlg-3 col-md-5">
                        <div class="card">
                          ...
                          <p>Наявність працівника для обслуговування транспортного засобу - 
                            <?php  if($vehicle_data['employee']){
                              echo "наявний";
                            } else{
                              echo "відсутній";
                            }
                          ...
                          <div>
                              ...
                              <table>
                                  ...
                                  <tr>
                                        <td COLSPAN="3" align="center"><b>ЗМІНИТИ ПЕРІОД ОРЕНДИ</b></td>
                                  </tr>
                                   <tr>
                                      ...
                                      <td class="txt-oflo">
                                            ...
                                            ?>
                                            <input type="date" id="party" name="date_from" min="2018-04-01" value="<?php echo $date;?>">
                                     ...
                                     <tr> 
                                      ...
                                      <tr>
                                       ...
                                       <tr>
                                            <td class="txt-oflo" colspan="2">  СТАТУС ОПЛАТИ: </td>
                                            <td class="txt-oflo">
                                             <?php 
